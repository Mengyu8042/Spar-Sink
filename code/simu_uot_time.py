...
n_list = np.array([800, 1600, 3200, 6400, 12800, 25600])
    ...
    for j in range(len(n_list)):
        ...
        for k in range(len(eps_list)):
            ...
            if i < nloop_sink:
                ...
                T = ot.unbalanced.sinkhorn_unbalanced(a, b, M, epsilon, reg_kl, stopThr=1e-10)
            ...
            #%% Spar-Sink
            start1 = time.process_time()
            WFR_spar, _ = spar_sinkhorn_unbalanced(a, b, M, K, s, epsilon, reg_kl)
...
plt.show()
# plt.savefig('time_uot.png', dpi=200, bbox_inches='tight')
# plt.close('all')
